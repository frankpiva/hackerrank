...
For example, cat
is at position and cat is at . If mouse is at position , it is units from cat and unit from cat . Cat
...
For each query, return Cat A if cat
...
# approach: computer both distances and compare
# memory: O(1)
# runtime: O(1)
