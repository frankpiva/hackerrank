...
, the page that Brie's teacher wants her to turn to.
...
If Brie starts turning from page
, she only needs to turn
...
Because we want to print the minumum number of page turns, we print
...
, she doesn't need to turn any pages:

Untitled Diagram(5).png

Because we want to print the minimum number of page turns, we print
as our answer.
"""
...
# approach: calculate from both directions, return the minimum
# memory: O(1)
# runtime: O(1)
def pageCount(n, p):
